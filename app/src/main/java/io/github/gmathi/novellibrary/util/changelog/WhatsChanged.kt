...
object WhatsChanged {
    ...
    const val LATEST = "🎉 v1.2.2 Release!\n" +
            ...
            "⚠️ Fixed - Status bar overlap on activities without AppBarLayout\n" +
            "⚠️ Fixed - Last chapter hidden behind navigation bar on chapters screen\n" +
            "⚠️ Fixed - Cloudflare related issues\n" +
            "🛠️ Code restructure and cleanup\n"
