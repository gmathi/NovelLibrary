...
public abstract class SlidingActivity extends PeekViewActivity {
     ...
     */
    public void setFab(int color, int drawableRes, OnClickListener onClickListener, int tintColor) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            fab.getDrawable().mutate().setTint(ContextCompat.getColor(this, tintColor));
        }
